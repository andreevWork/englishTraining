...
function toSeconds (time) {
  ...
  try {
    ...
    return (parseFloat(t[1], 10) || 0) * 3600 + parseFloat(t[0], 10) * 60 + parseFloat(s[0], 10) + parseFloat(s[1], 10) / 1000
  } catch (e) {
    return 0
  }
}
 ...
 */
module.exports = function parseSRT (data = '') {
